...
func (su *SwiperUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *SwiperUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (suo *SwiperUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *SwiperUpdateOne {
