...
//		GroupBy(medicalrecord.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.MedicalRecord.Query().
//		Select(medicalrecord.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (mrq *MedicalRecordQuery) Modify(modifiers ...func(s *sql.Selector)) *MedicalRecordSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (mrs *MedicalRecordSelect) Modify(modifiers ...func(s *sql.Selector)) *MedicalRecordSelect {
