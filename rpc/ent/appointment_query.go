...
func (aq *AppointmentQuery) Modify(modifiers ...func(s *sql.Selector)) *AppointmentSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (as *AppointmentSelect) Modify(modifiers ...func(s *sql.Selector)) *AppointmentSelect {
