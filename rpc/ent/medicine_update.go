...
func (mu *MedicineUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *MedicineUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (muo *MedicineUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *MedicineUpdateOne {
