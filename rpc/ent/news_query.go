...
func (nq *NewsQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (nq *NewsQuery) FirstIDX(ctx context.Context) uint64 {
...
func (nq *NewsQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (nq *NewsQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (nq *NewsQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (nq *NewsQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := nq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (nq *NewsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(news.Table, news.Columns, sqlgraph.NewFieldSpec(news.FieldID, field.TypeUint64))
	_spec.From = nq.sql
...
func (nq *NewsQuery) Modify(modifiers ...func(s *sql.Selector)) *NewsSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ns *NewsSelect) Modify(modifiers ...func(s *sql.Selector)) *NewsSelect {
