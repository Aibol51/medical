...
func (au *AppointmentUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *AppointmentUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (auo *AppointmentUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *AppointmentUpdateOne {
