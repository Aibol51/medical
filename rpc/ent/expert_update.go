...
func (eu *ExpertUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *ExpertUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (euo *ExpertUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *ExpertUpdateOne {
