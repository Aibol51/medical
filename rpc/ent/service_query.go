...
func (sq *ServiceQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (sq *ServiceQuery) FirstIDX(ctx context.Context) uint64 {
...
func (sq *ServiceQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (sq *ServiceQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (sq *ServiceQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (sq *ServiceQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *ServiceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(service.Table, service.Columns, sqlgraph.NewFieldSpec(service.FieldID, field.TypeUint64))
	_spec.From = sq.sql
