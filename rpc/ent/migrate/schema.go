...
var (
	...
	MedicinesColumns = []*schema.Column{
		...
		{Name: "description_zh", Type: field.TypeString, Nullable: true, Comment: "Description chinese | 药品中文描述"},
		{Name: "description_en", Type: field.TypeString, Nullable: true, Comment: "Description english | 药品英文描述"},
		{Name: "description_ru", Type: field.TypeString, Nullable: true, Comment: "Description russian | 药品俄语描述"},
		{Name: "description_kk", Type: field.TypeString, Nullable: true, Comment: "Description kazakh | 药品哈萨克语描述"},
		{Name: "remarks", Type: field.TypeString, Nullable: true, Comment: "Remarks | 备注信息"},
