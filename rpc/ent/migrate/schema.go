...
var (
	...
	MedicalRecordsColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime, Comment: "Create Time | 创建日期"},
		{Name: "updated_at", Type: field.TypeTime, Comment: "Update Time | 修改日期"},
		{Name: "patient_name", Type: field.TypeString, Comment: "Patient name | 姓名"},
		{Name: "gender", Type: field.TypeInt32, Comment: "Gender 1:male 2:female | 性别 1:男 2:女"},
		{Name: "age", Type: field.TypeInt32, Comment: "Age | 年龄"},
		{Name: "id_card_number", Type: field.TypeString, Nullable: true, Comment: "ID card number | 身份证号"},
		{Name: "phone_number", Type: field.TypeString, Comment: "Phone number | 电话"},
		{Name: "chief_complaint", Type: field.TypeString, Nullable: true, Comment: "Chief complaint | 主诉"},
		{Name: "present_illness", Type: field.TypeString, Nullable: true, Comment: "Present illness history | 现病史"},
		{Name: "past_history", Type: field.TypeString, Nullable: true, Comment: "Past history | 既往史"},
		{Name: "smoking_history", Type: field.TypeInt32, Nullable: true, Comment: "Smoking history | 吸烟史: 1-无, 2-有, 3-一般, 4-多, 5-已戒", Default: 1},
		{Name: "drinking_history", Type: field.TypeInt32, Nullable: true, Comment: "Drinking history | 饮酒史: 1-无, 2-有, 3-一般, 4-多, 5-已戒", Default: 1},
		{Name: "allergy_history", Type: field.TypeInt32, Nullable: true, Comment: "Allergy history | 过敏史: 1-无, 2-有", Default: 1},
		{Name: "heart_rate", Type: field.TypeInt32, Nullable: true, Comment: "Heart rate (beats/min) | 心率(次/分)"},
		{Name: "blood_pressure", Type: field.TypeString, Nullable: true, Comment: "Blood pressure (mmHg) | 血压(mmHg)"},
		{Name: "oxygen_saturation", Type: field.TypeFloat64, Nullable: true, Comment: "Oxygen saturation (%) | 指脉氧(%)"},
		{Name: "blood_glucose", Type: field.TypeFloat64, Nullable: true, Comment: "Blood glucose (mmol/L) | 血糖(mmol/L)"},
		{Name: "weight", Type: field.TypeFloat64, Nullable: true, Comment: "Weight (kg) | 体重(kg)"},
		{Name: "waist_circumference", Type: field.TypeFloat64, Nullable: true, Comment: "Waist circumference (cm) | 腰围(cm)"},
		{Name: "body_fat", Type: field.TypeFloat64, Nullable: true, Comment: "Body fat percentage (%) | 体脂数(%)"},
		{Name: "diagnosis", Type: field.TypeString, Nullable: true, Comment: "Diagnosis | 诊断"},
		{Name: "diet_therapy", Type: field.TypeInt32, Nullable: true, Comment: "Diet therapy | 饮食治疗"},
		{Name: "exercise_therapy", Type: field.TypeInt32, Nullable: true, Comment: "Exercise therapy | 运动治疗"},
		{Name: "medication_therapy", Type: field.TypeInt32, Nullable: true, Comment: "Medication therapy | 药物治疗"},
		{Name: "treatment_plan", Type: field.TypeString, Nullable: true, Comment: "Overall treatment plan | 综合治疗方案"},
