...
func (mru *MedicalRecordUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *MedicalRecordUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (mruo *MedicalRecordUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *MedicalRecordUpdateOne {
